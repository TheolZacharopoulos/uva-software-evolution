...
test bool testCompareTreesWhichAreEqual() {
    // same
    // sharedNodes = 5
    treeA = putIdentifiers(TestNodeA(TestNodeA(TestNodeB(4), TestNodeC("Test 2")), TestNodeC("Test"))); // mass = 5
    treeB = putIdentifiers(TestNodeA(TestNodeA(TestNodeB(4), TestNodeC("Test 2")), TestNodeC("Test")), 50);
...
test bool testCompareTreesWhichAreDifferent1() {
    ...
    treeA = putIdentifiers(TestNodeA(TestNodeA(TestNodeB(4), TestNodeC("Test 2")), TestNodeB(3))); // mass = 5
    treeB = putIdentifiers(TestNodeA(TestNodeA(TestNodeB(4), TestNodeC("Test 2")), TestNodeC("Test")), 50);
